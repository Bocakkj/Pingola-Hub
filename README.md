...
local Window = OrionLib:MakeWindow({Name = "Pingola hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Pingola hub"})
...
W:AddLabel("[+] Pingola hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Pingola hub(Noitification)",
